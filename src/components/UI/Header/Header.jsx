    ...
    <div className="fixed w-full h-[80px] bg-slate-300 flex justify-between items-center gap-8 px-[10%] py-4">
      ...
      <div className="relative flex-1 flex items-center">
        <input
          type="text"
          placeholder="Search..."
          className="text-md w-11/12 px-4 py-2 border-2 border-[#FBC100] rounded-lg outline-none"
        />
        <button className="absolute right-2 w-1/12 bg-[#FBC100] rounded-e-lg py-2 px-4 text-lg">
